<div class="form-horizontal">
  <form id="form1" action="{{ route('master-barang.update', [$data->id]) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="nama" value="{{ $data->nama }}" id="form-field-1" placeholder="Nama Barang.." class="col-xs-10 col-sm-5" />
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="keterangan" value="{{ $data->keterangan}}" id="form-field-1" placeholder="Opsional tidak harus diisi inputan.." class="col-xs-10 col-sm-5" />
      </div>
    </div>
