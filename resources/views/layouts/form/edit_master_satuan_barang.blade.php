<div class="form-horizontal">
  <form id="form1" action="{{ route('master-satuan-barang.update', [$data->id]) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="keterangan" value="{{ $data->keterangan }}" id="form-field-1" class="col-xs-10 col-sm-5" />
      </div>
    </div>
  </form>
