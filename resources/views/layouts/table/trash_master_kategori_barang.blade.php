              ...
              <tr>
                ...
                <td>
                  <div class="hidden-sm hidden-xs btn-group">
                    ...
                    <a href="{{ route('master-kategori-barang.restore',[$d->id]) }}" class="btn btn-xs btn-warning"
                    ...
                    <form id="delete" action="{{ route('master-kategori-barang.delete',[$d->id]) }}" method="POST"
                      style="display: none;">
                      @method('DELETE')
                      @csrf
                    </form>
                  ...
                  <div class="hidden-md hidden-lg">
                    <div class="inline pos-rel">
                      ...
                      <ul
                        ...
                        <li>
                          <a href="{{ route('master-kategori-barang.restore',[$d->id]) }}" class="tooltip-success"
                        ...
                        <li>
                          ...
                          <form id="delete" action="{{ route('master-kategori-barang.delete',[$d->id]) }}"
