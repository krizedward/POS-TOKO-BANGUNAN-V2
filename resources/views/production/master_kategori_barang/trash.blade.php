...
<div class="row">
  <div class="col-xs-12">
    <a href="{{ route('master-kategori-barang.index') }}" class="btn btn-app btn-success btn-sm">
    ...
    <a href="{{ route('master-kategori-barang.sampah') }}" class="btn btn-app btn-danger btn-sm">
