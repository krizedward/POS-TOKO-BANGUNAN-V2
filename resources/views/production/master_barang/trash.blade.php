...
<div class="row">
  <div class="col-xs-12">
    <a href="{{ route('master-barang.index') }}" class="btn btn-app btn-success btn-sm">
      <i class="ace-icon fa fa-table bigger-200"></i>
      Tabel
    </a>

    <a href="{{ route('master-barang.create') }}" class="btn btn-app btn-info btn-sm">
      <i class="ace-icon fa fa-book bigger-200"></i>
      Tambah
    </a>

    <a href="{{ route('master-barang.trash') }}" class="btn btn-app btn-danger btn-sm">
...
@include('layouts.table.trash_master_barang')
