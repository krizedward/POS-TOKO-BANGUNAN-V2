...
<div class="row">
  <div class="col-xs-12">
    <a href="{{ route('master-satuan-barang.index') }}" class="btn btn-app btn-success btn-sm">
      <i class="ace-icon fa fa-table bigger-200"></i>
      Tabel
    </a>

    <a href="{{ route('master-satuan-barang.create') }}" class="btn btn-app btn-info btn-sm">
      <i class="ace-icon fa fa-book bigger-200"></i>
      Tambah
    </a>

    <a href="{{ route('master-satuan-barang.trash') }}" class="btn btn-app btn-danger btn-sm">
      <i class="ace-icon fa fa-trash bigger-200"></i>
      Sampah
    </a>
  </div>
</div>
...
@include('layouts.table.trash_master_satuan_barang')
